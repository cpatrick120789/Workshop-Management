...
namespace Domain.Managers
{
    ...
    {
        public OrderManager(GenericRepository<Order> repository, Manager manager)
            : base(repository, manager)
        {
        }

        public OrderManager(DbContext context, Manager manager)
            : base(context, manager)
        {
        }

        public override OperationResult<Order> Add(Order element)
        {
